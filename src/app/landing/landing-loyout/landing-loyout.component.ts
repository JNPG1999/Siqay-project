...
export class LandingLoyoutComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    /* TITLE */
    this.title.setTitle(
      'Estudio de Arquitectura en Ica | Diseño Arquitectónico Moderno y Sostenible'
    );
    ...
    this.meta.updateTag({
      name: 'description',
      content:
        'Estudio de arquitectura en Ica especializado en diseño arquitectónico moderno, sostenible y funcional. Más de 15 años desarrollando proyectos residenciales y comerciales.',
    });

    /* ROBOTS */
    this.meta.updateTag({ name: 'robots', content: 'index, follow' });

    /* GEO SEO (MUY IMPORTANTE PARA LOCAL) */
    this.meta.updateTag({ name: 'geo.region', content: 'PE-ICA' });
    this.meta.updateTag({ name: 'geo.placename', content: 'Ica, Perú' });
    // this.meta.updateTag({ name: 'geo.position', content: '-14.0686;-75.7286' });
    // this.meta.updateTag({ name: 'ICBM', content: '-14.0686, -75.7286' });
    ...
    this.meta.updateTag({
      property: 'og:title',
      content:
        'Estudio de Arquitectura en Ica | Arquitectura Moderna y Sostenible',
    });

    this.meta.updateTag({
      property: 'og:description',
      content:
        'Estudio de arquitectura en Ica especializado en diseño arquitectónico moderno y sostenible para proyectos residenciales y comerciales.',
    });
    this.meta.updateTag({
      property: 'og:image',
      content: 'https://tudominio.com/assets/seo/arquitectura-ica.jpg',
    });
    this.meta.updateTag({
      property: 'og:url',
      content: 'https://tudominio.com/',
    });
  }
